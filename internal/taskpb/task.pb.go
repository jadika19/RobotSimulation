...
type CompletionRequest struct {
	...
	X             int32                  `protobuf:"varint,4,opt,name=x,proto3" json:"x,omitempty"`                            // Problem X coordinate
	Y             int32                  `protobuf:"varint,5,opt,name=y,proto3" json:"y,omitempty"`                            // Problem Y coordinate
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CompletionRequest) GetX() int32 {
	if x != nil {
		return x.X
	}
	return 0
...
func (x *CompletionRequest) GetY() int32 {
	if x != nil {
		return x.Y
	}
	return 0
...
const file_proto_task_proto_rawDesc = "" +
	...
	"\asuccess\x18\x03 \x01(\bR\asuccess\x12\f\n" +
